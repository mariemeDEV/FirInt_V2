            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <td>
                            <select class="form-control" name="avance_recours" id="avance-recours" style="height:33px !important" value='Avance sur recours'>
            ...
            <table class="table table-bordered mbn decompte-tab">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <select class="form-control" name="reduction-commerciale" id="reduction_commerciale" style='width:115px !important;height:32px !important'>
                                <option value="0">0</option>
                                <option value="5">5%</option>
                                <option value="10">10%</option>
                                <option value="15">15%</option>
