          ...
          <div class="row mb15 table-layout">
            ...
            <div class="col-xs-6 pln">
              <a href="index.php" title="Return to Dashboard">
                <img src="assets/img/logos/logo-footer.png" title="For-Int" class="img-responsive w250 forgot-pw-logo">
              </a>
            </div>
            ...
            <form method="post" action="/" id="contact">
              <div class="panel-body p15">
                ...
                <div class="alert alert-micro alert-border-left alert-info pastel alert-dismissable mn">
                  ...
                  <i class="fa fa-info pr10"></i>Saisissez votre<b> Email</b> et suivez les instructions sur le mail qui vous sera envoyé.
                </div>
              ...
              <div class="panel-footer p25 pv15">
                ...
                <div class="section mn">
                  ...
                  <div class="smart-widget sm-right smr-80">
                    ...
                    <a href="form_reset_pw.php">Reset</a>
                    <!--label for="email" class="button">Valider</label-->
                  </div>
