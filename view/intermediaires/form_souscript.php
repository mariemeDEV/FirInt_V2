 ...
 <form method='POST' id="souscription-form" class="auto-form">
      <div>
        ...
        <h3>Caractéristiques du véhicule</h3>
            ...
            <div class="row">
                ...
                <div class="col col-md-4" id="mise_en_circulation_col">
                    ...
                    <input id="date_circulation" name="dateDeMiseEnCirculation" type="date">
                </div>
            ...
            <div class="row">
                <div class="col col-md-4" id="cylindre_col">
                    <label for="Cylindre">Cylindre<span class="require-caracter">*</span></label>
                    <input id="cylindre" name="cylindre" type="number" required>
                </div>
        ...
        <section class='recap-sector' id='recap-section' style='color:black;margin-left: -23px !important'>
            ...
            <img src="./assets/img/patterns/prime.png" class="animated fadeInLeft animation-delay-100" style='width: 112%;margin-left:-1px;filter: contrast(0.5)'>
            <section class='prime-sector' id='prime-recap-section' style='display:none'>
