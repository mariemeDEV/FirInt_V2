      ...
      <section id="content">
        ...
        <div class="admin-form theme-info mw500" id="login">
          ...
          <div class="panel mt30 mb25">
            ...
            <form method="post" action="/" id="contact">
              <div class="panel-body bg-light p25 pb15">
                ...
                <!-- Password Input -->
                <div class="section">
                  <label for="username" class="field-label text-muted fs18 mb10">Nouveau mot de passe</label>
                ...
                <!-- Password Input -->
                <div class="section">
                  <label for="username" class="field-label text-muted fs18 mb10">Confirmer le mot de passe</label>
                  <label for="password" class="field prepend-icon">
                    <input type="password" name="password" id="password" class="gui-input" placeholder="Confirmer le mot de passe">
                    <label for="password" class="field-icon">
                      <i class="fa fa-lock"></i>
                    </label>
                  </label>
              ...
              <div class="panel-footer clearfix">
                <button type="submit" class="button btn-primary mr10 pull-right">Valider</button>
              </div>
          ...
          <div class="login-links">
            <p>
              <a href="connexion.php" class="active">Retour à la page de connexion</a>
            </p>
            <p>For-Int
