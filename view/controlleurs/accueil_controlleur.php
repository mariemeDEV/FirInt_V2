    ...
    <div id="main" class="container-fluid accueil-content">
        ...
        <div class="row fonctionalites-row"><!--row-->
            <div class="col-md-4 col-lg-7 fonctionalities-side"><!--Begin left side-->
                <div class="row f-row">
                    <a href="admin_index.php" disabled="disabled"><div class="col-md-4 col-lg-6 fonctionnality f1"><i class="glyphicons glyphicons-cars"><p>Utilisateurs</p></i></div></a>
                ...
                <div class="row f-row">
                    <a href="admin_index.php" disabled="disabled"><div class="col-md-4 col-lg-6 fonctionnality f5"><i class="glyphicons glyphicons-folder_open"><p>Commandes</p></i></div></a>
                    <a href="admin_index.php" disabled="disabled"><div class="col-md-4 col-lg-6 fonctionnality f6"><i class="glyphicons glyphicons-notes"><p>Avenants</p></i></div></a>
                </div>
                <div class="row f-row">
                    <a href="admin_index.php" disabled="disabled"><div class="col-md-4 col-lg-6 fonctionnality f3"><i class="glyphicons glyphicons-suitcase"><p>Dotation</p></i></div></a>
