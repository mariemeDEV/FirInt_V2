          ...
          <li class="dropdown-header">
            ...
            <li class="media">
              <div class="media-body">
                <h5 class="media-heading">Voiture type <a class="text-system divide" href="#"> Essence </a>
                  <small class="text-muted">7 à 10 cheveaux  <a class="text-system divide" href="#"> 15 places </a></small>
                </h5> Prime
                <a class="text-system divide" href="#"> 17701 </a>
              </div>
            </li>
            <li class="media">
              <div class="media-body">
    ...
    <aside id="sidebar_left" class="nano nano-primary">
      ...
      <div class="sidebar-left-content nano-content">
        ...
        <ul class="nav sidebar-menu">
          <li class="sidebar-label pt20">Gestion utilisateurs</li>
          <li>
          ...
          <li class="sidebar-label pt15">Gestion Production</li>
          <li>
          ...
          <li class="sidebar-label pt15">Gestion Dotation</li>
          <li>
          ...
          <li class="sidebar-label pt15">Gestion annulations</li>
          <li>
            <a href="garanties.php">
              <span class="fa fa-calendar"></span>
          ...
          <li class="sidebar-label pt15">Gestion commandes</li>
          <li>
            <a href="garanties.php">
              <span class="fa fa-calendar"></span>
              <span class="sidebar-title">Garanties</span>
